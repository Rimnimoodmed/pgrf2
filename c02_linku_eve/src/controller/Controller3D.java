...
import rasterize.LineRasterizerPrimitive;
...
public class Controller3D {
    ...
    public Controller3D(Panel panel) {
        ...
        lineRasterizer = new LineRasterizerPrimitive(zBuffer);
        ...
        panel.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_X) {
                    selected.setModel(new Mat4RotX(0.3).mul(selected.getModel()));
                }
                if (e.getKeyCode() == KeyEvent.VK_Y) {
                    selected.setModel(new Mat4RotY(0.3).mul(selected.getModel()));
                }
                if (e.getKeyCode() == KeyEvent.VK_Z) {
                    selected.setModel(new Mat4RotZ(0.3).mul(selected.getModel()));
                }
